...
which blocks the bank-transfer deposit route, and five raised by **[DEC-161]**'s Balance redesign —
[OQ-108], [OQ-109], [OQ-113], [OQ-114] and [OQ-115] — none of which blocks anything, each shipping
...
| **[OQ-108]** 🟠 | **The transfer instructions have no BIC**, although **[F07-R13]** (Must) names one. Registered by **[DEC-161]**; full row and fallback in [80-open-questions.md](../80-open-questions.md) §Money & wallet / Balance round |
| **[OQ-109]** 🟠 | **No read shows the withdrawal destination or the approval terms before the first request**, although **[F07-R33]** (Must) requires both. Registered by **[DEC-161]**; full row and fallback in [80-open-questions.md](../80-open-questions.md) |
| **[OQ-113]** 🟡 | **`CANCELLED`** (**[F07-R08]**) **has no writer** — neither the webhook nor **[DEC-159]**'s simulated-checkout endpoint can write it. Registered by **[DEC-161]**; full row and fallback in [80-open-questions.md](../80-open-questions.md) |
| **[OQ-114]** 🟡 | **No `returnUrl` survives sign-in**, so a customer bounced mid-checkout lands on the dashboard rather than back where they were. Registered by **[DEC-161]**; full row and fallback in [80-open-questions.md](../80-open-questions.md) |
| **[OQ-115]** 🟡 | **Bank transfers have no demo simulator** — the counterpart **[DEC-159]** builds for iDEAL. Registered by **[DEC-161]**; full row and fallback in [80-open-questions.md](../80-open-questions.md) |
