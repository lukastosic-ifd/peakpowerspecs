...
CREATE TABLE market.price_indication_markup (
    ...
    created_at  timestamptz NOT NULL,                         -- no DEFAULT now() — Constraint 4; set explicitly by the writer
