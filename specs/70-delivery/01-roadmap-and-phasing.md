...
| **[OQ-23]** | ⏸ | Montel ticker symbols for the 24 products (widened 2026-09-23 by **[DEC-161]** from six); the markup's side (**bid** or **ask**); the sign convention for a negative quote; and licence/service coverage of the far offsets | Price indications (`p2c`) | Partial: **[DEC-80]** settled the markup as configurable with a 2% default; the symbols were never supplied, the two sources disagree on the side of the market (comment says **bid** and governs), and the sign convention plus far-offset coverage are unconfirmed |
